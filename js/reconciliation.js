...
import { $, escapeHtml, setMsg, materialLabel, getPublicImageUrl, todayISO, unitLabel, keysLookUnchanged, testSupabaseConnection, explainSupabaseError } from "./shared.js";
...
function render(scope){
  ...
  tbody.innerHTML = rows.map(r => {
    ...
    const imgCell = imgUrl ? `<img class="thumb" src="${imgUrl}" alt="img" />` : `<div class="thumb-placeholder"></div>`;
    const d = computeDiff(r);
